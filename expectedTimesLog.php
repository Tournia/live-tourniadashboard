<?php
	...
	for($p = 0; $p < $UM_loopLogPHPLength; $p++){
       /* $myInput = $UM_loopLogPHP[$p]; 
		...
		$sql2 = "INSERT INTO ExpectedTimesLog
        VALUES ('$tournamantName', '$dataRefreshCount', '$processID', '$status', '$matchId', '$pool', '$dateTime', '$expectedTime', '$ifReadyToPlay', '$ifPlayerPlaying', '$ifPlayerUnavailable', '$reloadDataTimeInterval', '$timeSinceLastRefresh', '$expectedTimeDifferenceCalc', '$timeDifferenceCalc')";
